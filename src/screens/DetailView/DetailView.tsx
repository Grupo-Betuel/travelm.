...
export const DetailView = () => {
  ...
  return (
    <div className={`grid-container ${styles.DetailViewWrapper}`}>
      <div className={`grid-column-3 ${styles.GalleryWrapper}`}>
...
Calzado Timberland del 37 al 43. Órdenes al [hidden information] ➡️ Disponible bajo pedido.</span>
        ...
        <div className={styles.DetailViewContentActions}>
          <Button icon={<MessageOutlined />} size="large" className="me-m">Mensaje</Button>
          <Button icon={<StarFilled />} size="large" className="me-m"></Button>
          <Button icon={<ShareAltOutlined />} size="large" className="me-m"></Button>
          <Button icon={<MoreOutlined />} size="large"></Button>
        </div>
        <div className={`d-flex-column gap-xx-s ${styles.DetailViewContentInfo}`}>
